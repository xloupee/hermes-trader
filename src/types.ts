...
export interface BotConfig extends MigrationFormatConfig {
  ...
  copyTradeRustAsyncPlatformFeeEnabled: boolean;
  copyTradeRustAsyncPlatformFeeAllowAllChats: boolean;
  copyTradeRustAsyncPlatformFeeCanaryChatIds: string[];
  copyTradeRustAsyncPlatformFeeCanaryWallets: string[];
  copyTradeRustAsyncPlatformFeeSource: "supabase" | "local-jsonl";
  copyTradeRustAsyncPlatformFeeLocalExecutionsPath: string;
  copyTradeRustAsyncPlatformFeePollMs: number;
  copyTradeRustAsyncPlatformFeeLookbackMs: number;
  copyTradeRustAsyncPlatformFeeStartupLookbackMs: number;
  copyTradeRustAsyncPlatformFeeMaxRows: number;
  copyTradeRustAsyncPlatformFeeMaxAttempts: number;
  copyTradeRustAsyncPlatformFeeConfirmationTimeoutMs: number;
  copyTradeRustAsyncPlatformFeeConfirmationPollMs: number;
